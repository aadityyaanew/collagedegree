    ...
    <SectionWrapper id="contact" className="section-padding bg-white border-t border-slate-200/80 relative">
      <div className="container-main">
        <motion.div
          ...
          className="max-w-3xl mx-auto bg-crimson-50/50 rounded-2xl sm:rounded-3xl border-2 border-crimson/20 p-6 sm:p-12 text-center relative"
        >
          {/* Badge */}
          ...
          {/* Description */}
          <p className="text-body max-w-xl mx-auto mb-7 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4">
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 px-8 h-12 rounded-xl bg-crimson hover:bg-crimson-dark text-white font-semibold text-sm sm:text-base shadow-xs transition-all active:scale-98 cursor-pointer touch-manipulation w-full sm:w-auto"
            >
