...
export default function CollegeDetailClient({ initialCollege }) {
  const [college] = useState(initialCollege);
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-xl p-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  {college.about || `${college.name} is a leading higher education institution offering accredited programs with modern campus infrastructure, strong placement track records, and distinguished faculty.`}
                </p>
              </div>
                      ...
                      {college.fees && Object.keys(college.fees).length > 0 ? (
                        ...
                        <tr>
                          <td colSpan={2} className="px-5 py-6 text-center text-slate-500">
                            Fee details available on enquiry. Contact our counselling team for fee structures & scholarship assistance.
                          </td>
                        </tr>
                      )}
                    </tbody>
                ...
                <div className="flex flex-wrap gap-2">
                  {college.topRecruiters && college.topRecruiters.length > 0 ? (
                    ...
                    <p className="text-xs text-slate-500">
                      Prominent recruiters include top MNCs, tech giants, and consultancy firms.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-slate-100">
                  ...
                  <span className="text-lg font-bold text-navy">
                    {college.nirfRanking ? `#${college.nirfRanking}` : "Ranked in Top Tier"}
                  </span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-slate-100">
